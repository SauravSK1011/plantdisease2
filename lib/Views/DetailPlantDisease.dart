...
class DetailPlantDisease extends StatefulWidget {
  ...
  const DetailPlantDisease(
      {super.key, required this.plantDisease, required this.uploadResponse});
            ...
            child: Column(
                ...
                children: [
                  ClipRRect(
                      ...
                      child: Image.network(widget.uploadResponse!.imageUrl)),
                  SizedBox(
                    height: 50,
                  ),
                  Column(
